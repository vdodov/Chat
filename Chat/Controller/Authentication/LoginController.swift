...
class LoginController: UIViewController {
  ...
  private let dontHaveAccountButton: UIButton = {
    ...
    let attributedTitle = NSMutableAttributedString(string: "Don't have an acoount? ", attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 16), NSAttributedString.Key.foregroundColor : UIColor.white])
...
//      self.dismiss(animated: true, completion: nil)
  ...
  func configureUI() {
    ...
    navigationController?.navigationBar.barStyle = .black //상태바 화이트컬러
